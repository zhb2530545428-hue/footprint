...
import { allow_library_path, create_library, check_library } from "@/lib/desktop/tauri-bridge";
...
interface LibrarySetupOverlayProps {
  onLibraryReady: () => void;
}

export default function LibrarySetupOverlay({ onLibraryReady }: LibrarySetupOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-md rounded-panel bg-white px-8 py-10 text-center shadow-[0_8px_30px_rgba(0,0,0,0.12)] ring-1 ring-black/[0.06]">

        <h1 className="text-[22px] font-semibold tracking-tight text-foreground">
          Set up your Footprint Library
        </h1>

        {step === "choose" && (
          <>
            <p className="mt-3 text-[15px] text-muted leading-relaxed">
              Choose a local folder to store your journeys, photos, notes, and
              categories.
            </p>
